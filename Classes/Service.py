...
class Service:
	...
	def setFlag(self, host, teamName):
		try:	
			...
			flag64 = flag.encode('base64')
			self.argList[teamName] = self.module.set_flag(host, self.port, flag64)
	...
	def getFlag(self, host, teamName):
		try:
			...
			flag64 = self.module.get_flag(host, self.port, flag_id, token)
			flag = flag64.decode('base64')
